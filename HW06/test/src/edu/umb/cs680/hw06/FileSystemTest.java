...
class FileSystemTest {
    ...
    void AppendRoottest(){
        ...
        Directory dirtest=new Directory(null,"Testdir",0,LocalDateTime.now());
        fileSystem.appendRootDir(dirtest);
        assertEquals("Testdir",fileSystem.getRootDirs().get(1).getname());
    }
