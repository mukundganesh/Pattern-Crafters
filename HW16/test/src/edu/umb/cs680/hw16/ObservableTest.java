...
class ObservableTest {
    ...
    void Stock_Quote_Observable_notify_test() throws InterruptedException {
        ...
        for(int i=0;i<3;i++){
            ...
            System.out.println("This is quote  "+quote);
            stockQuoteObservable.changeQuote(ticker,quote);
            Thread.sleep(2000);
            assertEquals(stockQuoteObservable.getStringDoubleTreeMap(),lineChartObserver.getmap());
            assertEquals(stockQuoteObservable.getStringDoubleTreeMap(),threeDObserver.getmap());
            assertEquals(stockQuoteObservable.getStringDoubleTreeMap(),tableObserver.getmap());
        }
