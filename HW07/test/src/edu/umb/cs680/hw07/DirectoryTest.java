...
class DirectoryTest {
    ...
    @Test
    void isChildrenTest(){
        assertEquals(5,f.getRootDirs().getFirst().getChildren().size());
    }
    ...
    @Test
    void countchildtest(){
        assertEquals(5,f.getRootDirs().getFirst().countChild());
    }
    @Test
    void getfilestest(){
    ...
    void isLinktest(){
        ...
        assertFalse(f.getRootDirs().get(0).getChildren().get(3).isLink());
    }
